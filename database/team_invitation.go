...
type TeamInvitation interface {
	GetTeamInvitationByEmail(connection *gorm.DB, teamInvitation *go_saas_model.TeamInvitation) (*go_saas_model.TeamInvitation, error)
	GetTeamInvitationByTeamId(connection *gorm.DB, teamInvitation *go_saas_model.TeamInvitation) (*go_saas_model.TeamInvitation, error)
